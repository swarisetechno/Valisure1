...
const Login = () => {
  ...
  // Mock credentials for 4 user types
  const mockCredentials = [
    { email: "admin@valisure.com", password: "admin123", role: "admin", name: "Admin" },
    { email: "author@valisure.com", password: "author123", role: "author", name: "Author" },
    { email: "user@valisure.com", password: "user123", role: "user", name: "User" },
    { email: "approval@valisure.com", password: "approval123", role: "approval", name: "Approver" },
  ];
        ...
        <div className="w-full max-w-[512px] bg-[hsl(var(--brand-card))] border border-[hsl(var(--brand-card-border)/0.4)] shadow-[0px_20px_40px_rgba(31,27,22,0.06)] rounded-xl px-6 sm:px-12 pt-12 sm:pt-[73px] pb-12 flex flex-col gap-10">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <ul className="text-xs text-blue-800 space-y-1">
              <li>👤 Admin: admin@valisure.com / admin123</li>
              <li>✍️ Author: author@valisure.com / author123</li>
              <li>👥 User: user@valisure.com / user123</li>
              <li>✅ Approver: approval@valisure.com / approval123</li>
            </ul>
          </div>
